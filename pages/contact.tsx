  ...
  return (
    <>
      <nav className="bg-gradient-to-r from-slate-900 to-slate-800 border-b border-amber-600/30 sticky top-0 z-40 shadow-sm">
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-8">
            ...
            <Link href="/contact" className="text-slate-300 hover:text-amber-400 transition-colors font-medium text-amber-400 border-b-2 border-amber-400">
              Contact
            </Link>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <p className="text-slate-600 text-lg mb-12">Get in touch with our legal team for a confidential consultation</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-8 text-center">
            ...
            <p className="text-slate-600">info@bainbridgelaw.com</p>
          </div>
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-8 text-center">
            <div className="text-3xl mb-3">📍</div>
            <h3 className="font-bold text-slate-900 mb-2">Address</h3>
            <p className="text-slate-600">123 Legal Street<br/>Law City, ST 12345</p>
          </div>
        </div>
